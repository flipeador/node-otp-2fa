/*
    ...
    https://github.com/flipeador/node-otp-2fa
*/
 ...
 */
export function hotp(algorithm, secret, counter)
{
 ...
 */
export function totp(algorithm, secret, time, length)
{
 ...
 */
export function generateHOTP(options)
{
